...
export function HabitsList({ date, handleCompletedPercentage, habitsInfo, onCompletedChanged }: HabitsListProps) {
  ...
  return (
    <div className='mt-6 flex flex-col gap-3 z-20 h-44 p-2 scrollbar-thin scrollbar-thumb-[color:var(--primary-border-color)] scrollbar-track-[color:var(--bg-color-modal)]  overflow-y-scroll'>
